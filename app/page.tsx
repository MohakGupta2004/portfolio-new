    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 flex justify-center pt-24 px-4 sm:px-6 h-screen overflow-auto">
        <div className="w-full max-w-5xl">
          ...
          {/* Unified three-column grid */}
          <div className="grid md:grid-cols-12 gap-6 items-start">

            {/* Left Column: TechStack Card */}
            ...
            {/* Middle Column: Profile, ToolStack, and ContentCards */}
            <div className="flex flex-col col-span-7 lg:col-span-7 gap-6">
             <DraggableWrapper>
              <ProfileCard />
              </DraggableWrapper> 

              {/* ToolStack and ContentCards in a row */}
            ...
            {/* Right Column: Links, Galaxy, and Projects */}
